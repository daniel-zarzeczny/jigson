...
class AllIfAnyMatchingStrategy extends AbstractJsonArrayFilterStrategy {

    static final AllIfAnyMatchingStrategy INSTANCE = new AllIfAnyMatchingStrategy();

    private AllIfAnyMatchingStrategy() {
    }
